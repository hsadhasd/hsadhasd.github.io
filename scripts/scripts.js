...
async function request_1(file,id){
  ...
  let txt = ""
  txt = txt + "<tr>" + "<th>" + "Num" + "</th>"+ "<th>" + "Image" + "</th>" + "<th>" + "Name" + "</th>"+ "<th>" + "Buy" + "</th>"  + "<th>" + "Sell" + "</th>"+ "<th>" + "%" + "</th>"+ "<th>" + "Cut" + "</th>" + "<th>" + "Stock" + "</th>" + "</tr>"; 
  for (g in myArr.items) {
    ...
    if (myArr.items[g].change_buy === 0) {
  	  txt = txt + "<tr>" + "<td>" + g + "</td>" + "<td>" + "<a target=_blank href="+link+">"+"<img src=https://community.cloudflare.steamstatic.com/economy/image/6TMcQ7eX6E0EZl2byXi7vaVKyDk_zQLX05x6eLCFM9neAckxGDf7qU2e2gu64OnAeQ7835Fe5GLEfDY0jhyo8DEiv5daPq0_qrw_QfG9DKWskiE/360fx360f height=35 width=35></img></a>" + "</td>" + "<td><a target=_blank href="+link+">"+ name + "</a></td>"+ "<td>$" + myArr.items[g].buy + "</td>"+ "<td>$" + myArr.items[g].sell + "</td>"+ "<td><a style=color:#ADD8E6>" + myArr.items[g].change_buy + "</a></td>"+ "<td>" + myArr.items[g].cut + "</td>" + "<td>" + myArr.items[g].stock + "</td>"+"</tr>"; 
    }
    if (myArr.items[g].change_buy > 0) {
  	  txt = txt + "<tr>" + "<td>" + g + "</td>" + "<td>" + "<a target=_blank href="+link+">"+"<img src=https://community.cloudflare.steamstatic.com/economy/image/6TMcQ7eX6E0EZl2byXi7vaVKyDk_zQLX05x6eLCFM9neAckxGDf7qU2e2gu64OnAeQ7835Fe5GLEfDY0jhyo8DEiv5daPq0_qrw_QfG9DKWskiE/360fx360f height=35 width=35></img></a>" + "</td>" + "<td><a target=_blank href="+link+">"+ name + "</a></td>"+ "<td>$" + myArr.items[g].buy + "</td>"+ "<td>$" + myArr.items[g].sell + "</td>"+ "<td><a style=color:#90EE90>" + myArr.items[g].change_buy + "</a></td>"+ "<td>" + myArr.items[g].cut + "</td>" + "<td>" + myArr.items[g].stock + "</td>"+"</tr>"; 
    }
    if (myArr.items[g].change_buy < 0) {
  	  txt = txt + "<tr>" + "<td>" + g + "</td>" + "<td>" + "<a target=_blank href="+link+">"+"<img src=https://community.cloudflare.steamstatic.com/economy/image/6TMcQ7eX6E0EZl2byXi7vaVKyDk_zQLX05x6eLCFM9neAckxGDf7qU2e2gu64OnAeQ7835Fe5GLEfDY0jhyo8DEiv5daPq0_qrw_QfG9DKWskiE/360fx360f height=35 width=35></img></a>" + "</td>" + "<td><a target=_blank href="+link+">"+ name + "</a></td>"+ "<td>$" + myArr.items[g].buy + "</td>"+ "<td>$" + myArr.items[g].sell + "</td>"+ "<td><a style=color:#FFCCCB>" + myArr.items[g].change_buy + "</a></td>"+ "<td>" + myArr.items[g].cut + "</td>" + "<td>" + myArr.items[g].stock + "</td>"+"</tr>"; 
    }
 }
