...
async function request_1(file,id){
  ...
  for (g in myArr.items) {
    ...
    let link = "https://steamcommunity.com/market/listings/252490/"+nameE;
  	txt = txt + "<tr>" + "<td>" + g + "</td>" + "<td>" + "<img src=images/big_grin.png alt= height=50 width=50></img>" + "</td>" + "<td><a target=_blank href="+link+">"+ name + "</a></td>"+ "<td>$" + myArr.items[g].buy + "</td>"+ "<td>$" + myArr.items[g].sell + "</td>"+ "<td>" + myArr.items[g].stock + "</td>"+"</tr>"; 
  }
