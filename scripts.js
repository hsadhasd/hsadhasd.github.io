...
async function request_2(file,id){
  ...
  if (myArr.dmarket.status === "True") {
    txt = txt + "<a title=Online style=color:green target=_blank href=https://dmarket.com/ingame-items/item-list/rust-skins>cs.deals</a>("+"<a title=Balance on dmarket.com>"+myArr.csdeals.balance+"</a>"+")/"
  }
  else {
